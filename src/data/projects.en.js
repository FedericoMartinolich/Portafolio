export default {
  checking: {
    ...
    detail: {
      ...
      process: [
        ...
        "Backend development using PHP and MySQL for data management.",
        "Creation of an intuitive user interface with HTML, CSS, and JavaScript.",
        "System testing and validation with real users."
      ],
      result: `
      ...
      `,
      galleryText: [
        "Login screen for teachers using ID number and password.",
        "Attendance registration interface with student limitations indicator.",
        "Attendance report by class with percentage calculation and record management.",
        "Configuration screen for attendance percentage rules."
      ]
    }
  },
  ...
  foodservice: {
    ...
    detail: {
      ...
      `,
      process: [
        "Analysis of the proprietary framework structure.",
        "User authentication system development.",
        "Meal order management module implementation.",
        "Manual integration of Tesseract OCR.",
        "OCR text processing and cleanup.",
  ...
  "tiro-libre": {
    ...
    detail: {
      ...
      `,
      process: [
        "Database modeling for users, fields and reservations.",
        "Role-based authentication and dashboards.",
        "Field creation and schedule management.",
      ...
      `,
      galleryText: [
        "Field detail view for players with booking options.",
        "Dark mode field detail view.",
        "Owner dashboard with reservation management.",
        "Player homepage with search tools.",
        "Interactive map with nearby fields.",
        "Pending reservation management panel."
      ]
    }
  },
  ...
  mecha: {
    ...
    detail: {
      ...
      `,
      process: [
        "Design review and layout planning.",
        "HTML structure creation.",
        "CSS styling and visual refinement.",
