export default {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "There was no automatic control of the student limit per class.",
          "There were no clear reports to evaluate attendance per course."
        ]
      },
      {
        id: "solucion",
        ...
        media: [
          {
            index: 1,
            caption: "Attendance registration with the student limit indicator."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        media: [
          {
            index: 3,
            caption: "Configuration screen for attendance percentage rules."
          }
        ]
      },
      {
  ...
  foodservice: {
    ...
    blocks: [
      ...
      },
      {
        id: "carga",
        type: "text",
        title: "Automating the menu upload",
        content: `
        ...
        media: [
          {
            index: 4,
            caption: "Editable weekly menu form."
          }
        ]
      },
      {
        ...
        media: [
          ...
          {
            index: 7,
            caption: "OCR text preview and correction interface."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          "Order registry and daily attendance marking.",
          "Weekly summary with automatic alerts.",
          "Monthly order history with PDF export."
        ],
        media: [
          {
            index: 10,
            caption: "Weekly summary with alerts."
          },
          {
            index: 11,
            caption: "Monthly order history with PDF export."
          }
        ]
      },
      {
        ...
        media: [
          ...
          {
            index: 3,
            caption: "Roles and permissions configuration."
          }
        ]
      },
      {
        ...
        title: "Challenges",
        items: [
          "Working without external libraries or framework documentation.",
          "Stabilizing the OCR: it required extensive testing and adjustments."
        ]
      },
      {
        id: "resultado",
      ...
      },
      {
        ...
        captions: [
          ...
          "Weekly menu form.",
          "Editable menu options and user preferences.",
          "Menu upload screen using OCR.",
          "OCR text preview and correction interface.",
          "Meal selection interface for users.",
          "Order registry and attendance marking.",
    ...
    blocks: [
      ...
      },
      {
        ...
        media: [
          ...
          {
            index: 5,
            caption: "Pending reservation management panel."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        media: [
          {
            index: 0,
            caption: "Field detail view for players."
          },
          {
            index: 1,
            caption: "Field detail view in dark mode."
          }
        ]
      },
      {
        ...
        items: [
          ...
          "Search and filtering system performance.",
    ...
    blocks: [
      ...
      },
      {
        ...
        media: [
          ...
          {
            index: 5,
            caption: "Responsive menu implementation."
          }
        ]
      },
      {
        ...
        items: [
          ...
          "Adapting the design to multiple screen sizes."
        ]
      },
      {
        id: "resultado",
  ...
  kredit: {
    ...
    blocks: [
      ...
      },
      {
        ...
        title: "Challenges",
        items: [
          "Limited backend documentation: I interpreted the API behavior through testing and collaboration."
        ]
      },
      {
        id: "resultado",
  ...
  "ferreteria-el-moro": {
    ...
    blocks: [
      ...
      },
      {
        id: "empresa",
        type: "text",
        title: "Contact and the business",
        content: `
        ...
        media: [
          {
            index: 3,
            caption: "Contact section with interactive map."
          },
          {
            index: 4,
      ...
      },
      {
        ...
        items: [
          ...
          "Optimizing external image loading."
        ]
      },
      {
        id: "resultado",
      ...
      },
      {
        ...
        title: "All screenshots",
        captions: [
          "General product catalog view.",
          "Product detail view.",
          "Placeholder handling for missing images.",
          "Interactive map contact section.",
          "About us section.",
          "Shopping cart view.",
          "Cart modal with WhatsApp integration.",
  ...
  "estancias": {
    title: "Estancias - Integral Tourism Management System (Under Development)",
    ...
    blocks: [
      {
        ...
        type: "text",
        title: "Summary",
        content: "Estancias is an all-in-one management system tailored for tourism establishments, boutique hotels, rural lodges and holiday complexes. The project was designed to resolve real-world operational challenges related to complex bookings, multiple guests, split payments, additional services, dynamic availability, financial control, stock and user management. The architecture was conceived with a vision for growth towards a multi-establishment SaaS model."
      },
      {
        id: "problema",
        type: "text",
        title: "The problem",
        content: "Many tourism establishments manage bookings, guests, payments and services through manual processes or fragmented systems, leading to errors, a lack of traceability and operational difficulties. Furthermore, most basic systems fail to account for real-world scenarios such as group bookings, multiple guests, associated services or partial payments."
      },
      {
        id: "objetivo",
        type: "text",
        title: "Objective",
        content: "To develop a centralised platform capable of managing the entire operation of a tourism establishment, accurately modelling business complexity and enabling scaling towards future enterprise functionalities and SaaS models."
      },
      {
        id: "arquitectura",
        type: "text",
        title: "Architecture",
        content: "A domain-driven design approach was applied, identifying key entities, complex relationships and real operational rules. Priority was given to modularity, separation of concerns and the use of derived logic to minimise redundancy and facilitate system maintainability."
      },
      {
        id: "implementacion",
        type: "bullets",
      ...
      },
      {
        ...
        title: "Challenges",
        items: [
          "Modelling real scenarios where the person paying is not necessarily the person staying.",
          "Linking multiple guests, rooms, services and payments to a single booking without creating unnecessary coupling.",
          "Managing temporal availability through decoupled structures to scale."
        ]
      },
      {
        id: "resultado",
      ...
      },
      {
        ...
        type: "text",
        title: "What I learned",
        content: "It was the project where I went deepest into domain design and relational modelling: complex bookings, split payments and decoupled availability."
      },
      {
        id: "distinto",
        type: "text",
        title: "What would I do differently today?",
        content: "I would deliver smaller functional verticals from the start to validate the product with real users early on."
      }
    ]
  }
}
